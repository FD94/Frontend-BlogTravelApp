        ...
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-brand-light px-4">
            <div className="max-w-md w-full bg-white rounded-3xl shadow-soft border border-slate-100 p-8 md:p-10">
                ...
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-bold text-brand-dark tracking-tight">Login</h2>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="text-slate-600 font-bold w-full bg-brand-primary font-bold py-3.5 rounded-xl hover:bg-brand-secondary transition-all duration-300 shadow-lg shadow-brand-primary/25 active:scale-[0.98] text-slate-600 cursor-pointer"
                    >
                        Login
                    </button>
                </form>
